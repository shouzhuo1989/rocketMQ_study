...
public class DefaultMQProducerImpl implements MQProducerInner {
    ...
    private SendResult sendDefaultImpl(
        ...
        //当我们不启动nameServer broker的时候，topicPublishInfo不为null，但是messageQueueList的size为0
        /**
         * 第一步：获取topic路由信息   topicPublishInfo应该描述清楚该topic存在与哪些broker上，每个broker上都有哪些queue
         */
    ...
    private TopicPublishInfo tryToFindTopicPublishInfo(final String topic) {
        //从缓存中获取TopicPublishInfo    这个缓存的结构是ConcurrentMap<String/* topic */, TopicPublishInfo>
        ...
        if (brokerAddr != null) {
            ...
            try {
                ...
                if (this.tryToCompressMessage(msg)) {
                    //消息大于等于4k时，需要压缩，压缩成功后sysFlag变为1
