...
public class BrokerController {
    ...
    public boolean initialize() throws CloneNotSupportedException {
        ...
        /**
         * commitlog文件：BrokerController>>messageStore>>CommitLog>>mappedFileQueue
         * offset文件：BrokerController>>messageStore>>consumeQueueTable
         */
        ...
        if (result) {
            ...
            /**
             * 注册消息/命令处理器，其中最重要的就是SendMessageProcessor和PullMessageProcessor,
             * 一个收producer消息,一个发给consumer
             */
