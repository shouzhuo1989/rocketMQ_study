...
public class RouteInfoManager {
    ...
    public RegisterBrokerResult registerBroker(
        ...
        try {
            try {
                // 注册broker时  用的是写锁  可以知道在这个阶段每个注册broker的请求都是同步执行的
                this.lock.writeLock().lockInterruptibly();
                // 根据集群名称获取集群下所有的brokerName，注意这里用的是set，相同的brokerName是添加不进去的
                ...
                //假如根据brokerName获取到了brokerData，说明不是第一次注册
